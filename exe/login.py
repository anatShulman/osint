...
class Login(tk.Tk):
    def __init__(self):
        ...
        self.image_data = logo_string()

        self.image_bytes = base64.b64decode(self.image_data)
        self.image = tk.PhotoImage(data=self.image_bytes)
        ...
        self.username_entry = tk.Entry(self, font=('calibri', 14), bg='#fcfcfc')
        ...
        self.password_entry = tk.Entry(self, show="*", font=('calibri', 14), bg='#fcfcfc')
